...
public class contestimages extends HttpServlet {
    ...
    if(item.getFieldName().equals("org"))
        {   
          org=item.getString();
        }
        ...
        {   
          event=item.getString();
            ...
            try{
                ...
                con.conn();
                con.insert("insert into contests(contest_title,contest_desc,image_name,contest_link,last_date,event_date,contest_organisor) values('"+title+"','"+desc+"','"+path+"','"+link+"','"+last+"','"+event+"','"+org+"');");
