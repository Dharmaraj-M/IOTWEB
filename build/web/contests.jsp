...
try {
    ...
    connection.conn();
String QueryString = "SELECT contest_title,contest_desc,image_name,last_date,event_date,contest_organisor from contests ORDER BY contest_id DESC ;";
connection.read(QueryString);
int i=0;
while (connection.rs.next()) {
%>
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/contests/<%=connection.rs.getString(3)%>);"></div>
						<div class="text pt-4">
							
							<h3><a href="#"><%=connection.rs.getString(1)%></a></h3>
                                                        <p>Organizer: <%=connection.rs.getString(6)%></p>
							<p>Last Date: <%=connection.rs.getString(4)%></p>
                                                        <p>Event Date: <%=connection.rs.getString(5)%></p>
